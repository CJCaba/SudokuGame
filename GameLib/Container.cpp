...
/**
 * Add an item to the Container at a random position
...
/**
 * Release all items form the container and add them to the main game.
 */
...
/**
 * Draw the Container and its items onto the game board
